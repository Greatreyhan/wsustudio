      ...
      <div>
        <div className="flex w-10/12 gap-x-8 mx-auto py-8 items-center">
          <div className="flex-1">
            ...
            <Link to={to} className="mt-8 inline-flex bg-sky-900 text-white px-6 py-2 rounded-full items-center gap-2"><span>See Portofolios</span><IoIosArrowRoundForward className="text-2xl" /></Link>
          </div>
          <div className="flex-1">
